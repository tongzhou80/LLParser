...
class IRFlags {
    ...
    static std::set<string> _bitwise_binary_opcodes;
...
public:
    ...
    static bool is_bitwise_binary_opcode(const string& key)               { return _bitwise_binary_opcodes.find(key) != _bitwise_binary_opcodes.end(); }
