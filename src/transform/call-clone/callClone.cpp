...
//            auto& malloc_users = malloc->caller_list();
//            Function::InstList malloc_users_copy = malloc_users; // caller_list might change during the iteration since new functions may be created
//            for (auto uit = malloc_users_copy.begin(); uit != malloc_users_copy.end(); ++uit) {
//                Function* func = (*uit)->function();
//                do_clone(func, module);
//                //auto& users = func->caller_list();
//
//            }
